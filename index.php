...
<html lang="pt-br">
    <head>
        ...
        <title>Sistema de Login Vitor Systems</title>
        <style>
            #caixaCadastro,
            #caixaRecuperarSenha,
            #alerta{
      ...
      <!-- Formulario de cadastro -->
        <section class="row mb-5" >
            <div class="col-lg-4 offset-lg-4 bg-light rounded" id="caixaCadastro">
                ...
                <form action="#" class="p-2" id="frmCadastro"></form>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        class="form-control" placeholder="Nome de Usuario" required>
                    </div>

                    <div class="form-group">
                        <input type="email" name="emailUsuario" id="emailUsuario"
                         class="form-control" placeholder="E-mail de Usuario" required>
                    </div>
                    ...
                    <input type="password" name="senhaConfirma" id="senhaConfirma" 
                        class="form-control" placeholder="Confirma sua Senha" required>
                    </div>
        ...
        <section class="row mb-5">
            <div class="col-lg-4 offset-lg-4 bg-light rounded" 
                ...
                <form action="#" id="formSenha">
                    ...
                    <div class="form-group">
                        <input type="email" name="emailSenha" id="emailSenha" 
                        class="form-control" placeholder="E-mail" required>
                    </div>
                    <div class="form-group">
                        <input type="submit" value=":: Enviar e-mail ::" 
                        id="btnEnviar" class="btn btn-primary btn-block">
                    </div>
