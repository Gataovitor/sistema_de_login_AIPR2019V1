                    ...
                    <h4>
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                name="csenha" id="csenha" placeholder=" Confirma a Nova senha" required>
                            </div>
                            <div class="form-group">
                                <input type="submit" value=" :: Gerar nova senha ::"
                                name="criar" class="btn btn-primary btn-block" 
                                style="background: deepSkyBlue color: black; 
                        font-weigth:  bolder; padding: 10px; font-size: 22px;"
                        >
                            </div>
                        </form>
            </div>
